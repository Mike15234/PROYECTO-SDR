...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/popuser/SDR-course-material/prueba.wav', 1, 48000, 8)
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_gr_complex*1, '127.0.0.1', 5005, 1472, True)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_cc(3)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.blocks_udp_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 500000, 100000, firdes.WIN_HAMMING, 7))
